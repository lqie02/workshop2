...
<?php if(isset($_POST['submit'])){
   ...
   $query = $db->query("INSERT INTO rating SET score='".$rating."', R_remark='".$_POST['text']."', order_id ='".$_POST['order_id']."'");
...
<body>
	<div class="container">
		<?php if(isset($_GET['order_id'])){
            $order_info = $db->query("SELECT * FROM orders WHERE order_id='".$_GET['order_id']."'");
          }
